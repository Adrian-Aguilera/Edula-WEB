  ...
  <div class="ml-5 mr-5">
    <div class="flex flex-col mt-8 justify-between rounded-2 min-w-full p-4 rounded-lg border-gray-200 border-dashed " id="chat_section" style="height: 650px;">
      ...
      <div class="mb-3" v-if="isLoading === true">
        <div class="py-2.5 px-5 me-2 text-sm font-medium text-gray-300 rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center">
